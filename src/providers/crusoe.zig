//! Crusoe Serverless Inference client.

const compatible = @import("openai_compatible.zig");
const profiles = @import("profiles.zig");

pub const api_base = "https://api.inference.crusoecloud.com/v1";
pub const api_key_env = "CRUSOE_API_KEY";

const defaults: compatible.ClientDefaults = .{
    .base_url = api_base,
    .provider_name = "crusoe",
    .profile = profiles.openai_compatible.unknown,
    .model_profile_lookup = profiles.crusoe,
};
